...
function StorageService(options) {
  ...
  this.providerFolderKey = null;
  if (options.providerFolderKey && 'string' === typeof options.providerFolderKey) {
    this.providerFolderKey = options.providerFolderKey;
  }
  this.folder = null;
}
...
StorageService.prototype.uploadStream = function(container, file, options) {
  ...
  return this.handler.uploadStream(this.client, this.provider,
      container, file, this.folder, options);
};
...
StorageService.prototype.downloadStream = function(container, file, options) {
  ...
  return this.handler.downloadStream(this.client, this.provider,
    container, file, this.folder, options);
};
...
StorageService.prototype.getFiles = function(container, options, cb) {
  return this.handler.getFiles(this.client, this.provider,
    container, this.folder, options, cb);
};
...
StorageService.prototype.getFile = function(container, file, cb) {
  return this.handler.getFile(this.client, this.provider,
    container, file, this.folder, cb);
};
...
StorageService.prototype.removeFile = function(container, file, cb) {
  return this.handler.removeFile(this.client, this.provider,
    container, file, this.folder, cb);
};
...
StorageService.prototype.upload = function(container, req, res, options, cb) {
  ...
  options.providerFolderKey = this.providerFolderKey;
...
StorageService.prototype.download = function(container, file, req, res, cb) {
  return this.handler.download(this.client, this.provider,
      req, res, container, file, this.folder, cb);
};
